<template>
  <section
    class="container"
    :id="option.sectionId"
    :class="{ bordered: option.sectionId !== 'choose' }"
  >
...
.add-btn {
  ...
  align-items: center;
  height: 3rem;
  border: 2px solid rgb(132, 230, 86);
  border-radius: 6px;
  padding: 1rem 0.75rem;
  color: rgb(132, 230, 86);
  font-size: 1rem;
  cursor: pointer;
  transition: 300ms;
  ...
  &:hover {
    background: rgba(187, 235, 178, 0.726);
  }
...
.delete-btn {
  ...
  &:hover {
    background: rgba(231, 124, 124, 0.493);
  }
}
